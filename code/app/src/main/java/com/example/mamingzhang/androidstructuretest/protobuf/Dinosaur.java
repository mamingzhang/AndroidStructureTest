...
// Source file: dinosaur.proto at 7:1
package com.example.mamingzhang.androidstructuretest.protobuf;
...
public final class Dinosaur extends Message<Dinosaur, Dinosaur.Builder> {
  ...
  @WireField(
      tag = 5,
      adapter = "com.example.mamingzhang.androidstructuretest.protobuf.Period#ADAPTER"
  )
