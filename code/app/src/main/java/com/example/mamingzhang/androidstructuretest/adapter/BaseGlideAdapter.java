...
import com.example.mamingzhang.androidstructuretest.fragment.glide.GlideLargeImageFragment;
...
public class BaseGlideAdapter extends BaseAdapter {
    ...
    static {
        ...
        ExampleFragment.put("LargeImage", GlideLargeImageFragment.class);
    }
